<template>
  <section class="privacy">
    ...
    <h2 class="privacy__article">1. Общие положения.</h2>
    <p class="privacy__subarticle">
    ...
    <div class="privacy__article-table">
      <p class="privacy__article-line">1.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">2.</p>
      <p class="privacy__article-line">
    ...
    <div class="privacy__article-table">
      ...
      <p class="privacy__article-line">3.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">4.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">5.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">6.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">7.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">8.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">9.</p>
      <p class="privacy__article-line">
        Пользователь – любой посетитель веб-сайта http://raklechitsa.ru;
      </p>
      <p class="privacy__article-line">10.</p>
      <p class="privacy__article-line">
        Предоставление персональных данных – действия, направленные на раскрытие
        персональных данных определенному лицу или определенному кругу лиц;
      </p>
      <p class="privacy__article-line">11.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">12.</p>
      <p class="privacy__article-line">
      ...
      <p class="privacy__article-line">13.</p>
      <p class="privacy__article-line">
    ...
    <div class="privacy__article-table">
      <p class="privacy__article-line">1.</p>
      <p class="privacy__article-line">Фамилия, имя, отчество;</p>
      <p class="privacy__article-line">2.</p>
      <p class="privacy__article-line">Электронный адрес;</p>
      <p class="privacy__article-line">3.</p>
      <p class="privacy__article-line">Номера телефонов;</p>
      <p class="privacy__article-line">4.</p>
      <p class="privacy__article-line">Год, месяц, дата и место рождения;</p>
      <p class="privacy__article-line">5.</p>
      <p class="privacy__article-line">Фотографии;</p>
      <p class="privacy__article-line">6.</p>
      <p class="privacy__article-line">
    ...
    <h2 class="privacy__article">4. Цели обработки персональных данных</h2>
    <div class="privacy__article-table">
      <p class="privacy__article-line">1.</p>
      <p class="privacy__article-line">
    ...
    <h2 class="privacy__article">8. Заключительные положения</h2>
    <div class="privacy__article-table">
      <p class="privacy__article-line">1.</p>
      <p class="privacy__article-line">
...
.privacy__article:first-of-type {
  margin: 100px 0 0;
}
...
.privacy__article-table {
  width: 100%;
  margin: 30px 0 0;
  display: grid;
  grid-template-columns: 30px 740px;
  gap: 30px 10px;
}
...
@media screen and (max-width: 1280px) {
  ...
  .privacy__article-table {
    grid-template-columns: 30px 660px;
  }
}
...
@media screen and (max-width: 650px) {
  ...
  .privacy__article-table {
    margin: 20px 0 0;
    grid-template-columns: 16px 264px;
    gap: 20px 10px;
  }
}
</style>
